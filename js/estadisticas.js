        ...
        xhr.onload = function(){
        	if(this.status == 200){
                if(this.response && JSON.parse(this.response)){
                    ...
                    inc += "<li data-icon='clock'><a class='ui-icon-info'>Tiempo: <div id='hour' style='float:left;'>00</div>:<div id='minute' style='float:left;'>00</div>:<div id='second'>00</div></a></li>";
