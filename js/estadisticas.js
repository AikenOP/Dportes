        ...
        xhr.onload = function(){
        	if(this.status == 200){
                if(this.response && JSON.parse(this.response)){
                    ...
                    inc += "<li data-icon='clock'><div style='float:left;'>Tiempo</div> <div id='hour' style='float:left;'>00</div><div style='float:left;'>:</div><div id='minute' style='float:left;'>00</div><div style='float:left;'>:</div><div id='second'>00</div></li>";
